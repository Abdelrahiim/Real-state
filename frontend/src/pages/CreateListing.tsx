        ...
        <div className={"flex flex-col flex-1"}>
          ...
          {formData.imageURL.length > 0 && formData.imageURL.map((url, index) =>
            ...
            <div className={"flex justify-between p-3 border items-center"}>
              <img key={index} src={url} alt={"listing image"} className={"w-40 h-40 object-cover rounded-lg"}/>
          ...
          <button
            className={"p-3 mt-8 bg-slate-700 text-white rounded-lg uppercase hover:opacity-95 disabled:opacity-80"}>Create
            Listing
          </button>
